function myFunction(buttonId) {
    // Text Options
    if (buttonId == "1") {
        var copyandpaste = "> **Denied. Crashed/Disconnected in combat under 60%** \n" +
        "> \n" +
        "> The game will automatically restore you if you meet the requirements (Above 60% health in PvE), otherwise you can not be restored under ***any*** circumstance. \n" +
        "> \n" +
        "> We do not restore for Crashes/Disconnects in PVE and falling under 60% due to lingering issues \n" +
        "> \n" +
